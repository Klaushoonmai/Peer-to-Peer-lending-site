...
<div class="container-fluid p-2">
    <div class="card shadow" style="min-height: 88vh">
        <div class="card-body">
            <h5 class="p-2" style="border-bottom: 2px solid green;">Approved Loans</h5>
            <table class="table table-bordered">
            			...
            			List<Map<String,String>> data=DbHelper.executeDQL(sql,"Approved");
            			...
            			<td>
            			<a onclick="return confirm('Are you sure to release this loan ?')" 
            			href="loanrelease?id=<%= map.get("id") %>" class="btn btn-success btn-sm">Release Loan</a>
            			</td>
            			</tr>
            			<% } %>
            			</tbody>
